...
- [ ] **Step 1: main.tf 작성(locals + state bucket)**
...
- [ ] **Step 1: terraform 블록에 backend 추가**
...
- [ ] **Step 1: `docs/TERRAFORM_BOOTSTRAP.md` 작성**
...
- [ ] **Step 2: `docs/TERRAFORM_DEV.md` 에 CI 섹션 추가**
