...
- [ ] `main`이 `origin/main`과 동기화되고 clean인지 확인한다.
...
- [ ] 이슈 #199의 `Create a branch`로 브랜치를 생성한다(이슈-브랜치 자동 연결).
...
- [ ] **Step 1: `docs/TERRAFORM_DEV.md`의 dev BigQuery 섹션에 테이블 관리
...
- [ ] **Step 2: `docs/CHANGE_HISTORY.md`에 요약을 추가한다.** 기존 항목 형식을
