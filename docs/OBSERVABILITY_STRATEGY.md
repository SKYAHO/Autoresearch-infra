...
| Alerting | `#alerts-infra` Incoming Webhook 전환을 로컬 검증했고 live smoke 대기 중. workload allowlist는 `airflow`, `autoresearch`, `mlflow`, `monitoring`; warning은 무멘션 12시간, critical은 firing `@here`·4시간 반복, 둘 다 resolved 전송 |
