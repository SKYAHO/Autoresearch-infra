...
현재 단계에서는 Terraform dev 환경(VPC/subnet, Artifact Registry, Cloud SQL, GKE 클러스터) 구성을 완료하고, GitHub Actions(OIDC) 기반 Terraform plan 자동 검증(#6)을 추가하는 중입니다. 이후 권한/시크릿/모니터링 설정을 이 저장소에서 관리합니다.
